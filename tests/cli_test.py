...
from sghooker.cli import _detect_event_type, _load_env_config, app
...
@pytest.fixture
def mock_env_webhook_url() -> Generator[None, None, None]:
...
class TestSendTestMessageCommand:
    ...
    def test_nonexistent_file(
        ...
        # Assert
        file_not_found_exit_code = 2  # Exit code for file not found errors
        assert result.exit_code == file_not_found_exit_code
        mock_send_message.assert_not_called()
